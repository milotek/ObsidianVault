...
![[client_server_topology.png|400]]
...
Counter Strike uses a [[Learning/Sixth Form/Computer Science/Paper 2/Communications/3 - Client-Server + Peer to Peer/Client - Server model]] because the game is competitive - and not like a simple coop game which would use a [[Peer to Peer model]] instead.
